...
interface InterfaceValidator{
    function distributeBlockReward(address val, uint256 amount) external payable;
    function updateActiveValidatorSet(address[] memory newSet, uint256 epoch) external;
}
...
contract Proxy_Validator is Ownership {
...
// Following Proxy contract code taken from openzepelin: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/proxy/Proxy.sol
     ...
     */
    fallback() external payable onlyMiner virtual {
        _fallback();
    }
     ...
     * is empty.
     */
    receive() external payable onlyMiner virtual {
        _fallback();
    }
